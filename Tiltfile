...
docker_build("news_host_agent", context='./agents/news-host-agent/', dockerfile='./agents/news-host-agent/Dockerfile')
k8s_resource('news-host-agent', port_forwards='8000:8000', labels=['demo-workloads'])
